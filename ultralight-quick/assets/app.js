/* OpenChamber UI â€” static clone (no server, no build). Vanilla JS. */
(() => {
  'use strict';
  ...
  const SEED_SESSIONS = [
    {
      ...
      messages: [
        { role: 'user', text: 'Explique o que Ã© um for loop em JavaScript com um exemplo curto de cÃ³digo. Uma linha sÃ³.', time: '4:33 PM' },
        {
          role: 'assistant', time: '4:33 PM', model: 'DeepSeek V4 Pro', agent: 'build', duration: '10.9s',
          text: '**For loop** em JavaScript repete um bloco de cÃ³digo enquanto uma condiÃ§Ã£o for verdadeira, com inicializaÃ§Ã£o, condiÃ§Ã£o e incremento.',
          ...
          recap: 'For loop repete cÃ³digo enquanto condiÃ§Ã£o verdadeira; inicializaÃ§Ã£o, condiÃ§Ã£o, incremento. Exemplo: `for (let i=0; i<5; i++) console.log(i)` imprime 0 a 4.',
    ...
    { id: 'ses_clone_3', title: 'Mensagem de saudaÃ§Ã£o', messages: [] },
  ];
  ...
  const PLACEHOLDER_PHRASES = [
    'Defina um objetivo para esta sessÃ£o',
    'Me ajude a criar uma soluÃ§Ã£o',
    'Crie um cÃ³digo novo',
    'Explique este trecho de cÃ³digo',
    'Planeje uma nova funcionalidade',
    'Investigue um erro no projeto',
    'Organize o contexto desta tarefa',
    'Transforme uma ideia em execuÃ§Ã£o',
  ];

  const MODELS = ['DeepSeek V4 Pro', 'gpt-4o-mini', 'claude-sonnet-4-5', 'gemini-2.5-flash'];
  const AGENTS = ['Build', 'Plan', 'Ask'];
  const DESIGN_OPTIONS = [
    ['Default', 'EquilÃ­brio entre velocidade, contexto e profundidade.'],
    ['None', 'Respostas diretas, sem esforÃ§o adicional de raciocÃ­nio.'],
    ['Low', 'RaciocÃ­nio leve para tarefas simples e rÃ¡pidas.'],
    ['Medium', 'Mais contexto para decisÃµes e implementaÃ§Ãµes comuns.'],
    ['High', 'AnÃ¡lise aprofundada para problemas com vÃ¡rias partes.'],
    ['Extra high', 'Investiga alternativas, riscos e detalhes antes de responder.'],
    ['Max', 'MÃ¡xima profundidade e verificaÃ§Ã£o para tarefas crÃ­ticas.'],
  ];
  ...
  const MEMORY_NOTES = [
    {
      ...
      tag: 'Core memory',
      excerpt: 'O centro de gravidade das decisÃµes, padrÃµes e contexto que o agente reutiliza.',
      content: '# Zeno workspace\n\nEste Ã© o mapa vivo do contexto que o Zeno reuniu durante as sessÃµes. As notas prÃ³ximas representam ideias relacionadas; novas descobertas podem ser capturadas a qualquer momento.\n\n## Como ler\n\n- O nÃºcleo reÃºne o contexto mais importante.\n- Cada ramo organiza um tipo de memÃ³ria.\n- Clique em qualquer cartÃ£o para abrir a nota completa em Markdown.',
      accent: '#8b7cff',
      x: 50,
      y: 47,
      root: true,
    ...
    },
    {
      ...
      tag: 'Context',
      excerpt: 'Arquivos, limites e objetivos que definem a superfÃ­cie atual de trabalho.',
      content: '# Contexto do projeto\n\nO agente mantÃ©m aqui os sinais que ajudam a retomar uma tarefa sem recomeÃ§ar do zero.\n\n## Inclui\n\n- Pastas vinculadas ao projeto\n- Objetivos ativos\n- ConvenÃ§Ãµes descobertas nos arquivos\n- DependÃªncias que nÃ£o podem ser esquecidas',
      accent: '#58b6ff',
      x: 23,
      y: 24,
      updated: 'hÃ¡ 4 min',
    ...
    {
      id: 'memory-sessions',
      title: 'SessÃµes recentes',
      tag: 'Conversations',
      excerpt: 'Conversas que deixaram decisÃµes Ãºteis para as prÃ³ximas interaÃ§Ãµes.',
      content: '# SessÃµes recentes\n\nAs conversas do Zeno alimentam o mapa quando uma decisÃ£o, uma descoberta ou um padrÃ£o pode ser reutilizado.\n\n> Uma boa memÃ³ria reduz o caminho entre a pergunta e a prÃ³xima aÃ§Ã£o.\n\nUse **Capture note** na tela de Memory para guardar o Ãºltimo resultado da sessÃ£o atual.',
      accent: '#65d7c1',
      x: 78,
      y: 23,
      updated: 'hÃ¡ 8 min',
    ...
    {
      id: 'memory-decisions',
      title: 'DecisÃµes de produto',
      tag: 'Decisions',
      excerpt: 'Escolhas registradas para manter a interface coerente ao longo do tempo.',
      content: '# DecisÃµes de produto\n\nA interface deve ser silenciosa, densa e legÃ­vel. O mapa usa relaÃ§Ãµes visuais para mostrar contexto sem transformar a memÃ³ria em uma lista infinita.\n\n### PrincÃ­pios\n\n1. Mostrar o que Ã© relevante agora.\n2. Manter o detalhe a um clique de distÃ¢ncia.\n3. Preservar a paleta escura do Zeno.',
      accent: '#f0ad67',
      x: 20,
      y: 68,
      updated: 'hÃ¡ 18 min',
    ...
    {
      id: 'memory-patterns',
      title: 'PadrÃµes descobertos',
      tag: 'Patterns',
      excerpt: 'SoluÃ§Ãµes e estruturas que apareceram mais de uma vez no trabalho.',
      content: '# PadrÃµes descobertos\n\nO agente pode agrupar repetiÃ§Ãµes em notas menores e conectÃ¡-las ao contexto que as explica.\n\n```js\nconst memory = new Map();\nmemory.set("pattern", "reusable context");\n```\n\nEsse tipo de nota funciona como uma pequena biblioteca de decisÃµes prÃ¡ticas.',
      accent: '#e785b9',
      x: 80,
      y: 76,
      updated: 'hÃ¡ 22 min',
    },
    {
      ...
      tag: 'Workspace',
      excerpt: 'RelaÃ§Ãµes entre pastas, projetos e os chats que dÃ£o continuidade ao trabalho.',
      content: '# Projetos e escopos\n\nCada projeto pode reunir mais de uma pasta e manter seus prÃ³prios chats. Isso separa o contexto de uma iniciativa do restante das sessÃµes.\n\nAbra **Projects** na lateral para criar um novo escopo ou iniciar um chat dentro dele.',
      accent: '#b48cff',
      x: 49,
      y: 13,
      updated: 'hÃ¡ 31 min',
    },
    {
      ...
      tag: 'Capabilities',
      excerpt: 'Comandos, plugins e superfÃ­cies que o Zeno pode usar para transformar contexto em aÃ§Ã£o.',
      content: '# Ferramentas do agente\n\nShell, navegador e integraÃ§Ãµes aparecem como capacidades conectadas ao contexto. Marketplace serÃ¡ o lugar para descobrir novos plugins e skills.\n\nPor enquanto, esta nota representa o conjunto local de ferramentas disponÃ­vel nesta rÃ©plica estÃ¡tica.',
      accent: '#92d36e',
      x: 50,
      y: 87,
      updated: 'hÃ¡ 36 min',
    },
    { id: 'memory-skills', title: 'Skills', tag: 'Knowledge base', excerpt: 'Capacidades locais organizadas por Ã¡rea.', content: '# Skills\n\nMapa das capacidades disponÃ­veis na pasta `skills` do projeto.', accent: '#fff', x: 72, y: 48, updated: 'agora' },
    { id: 'skill-engineering', title: 'Engineering', tag: 'Skills', excerpt: 'ImplementaÃ§Ã£o, revisÃ£o e arquitetura.', content: '# Engineering\n\nSkills para implementar, revisar, testar e estruturar software.', accent: '#fff', x: 84, y: 30, updated: 'agora' },
    { id: 'skill-implement', title: 'Implement', tag: 'Engineering', excerpt: 'ImplementaÃ§Ã£o orientada por especificaÃ§Ãµes.', content: '# Implement\n\nExecuta trabalhos definidos por especificaÃ§Ãµes ou tickets.', accent: '#fff', x: 94, y: 17, updated: 'agora' },
    { id: 'skill-code-review', title: 'Code review', tag: 'Engineering', excerpt: 'RevisÃ£o de padrÃµes e requisitos.', content: '# Code review\n\nRevisa alteraÃ§Ãµes quanto a bugs, padrÃµes e aderÃªncia Ã  especificaÃ§Ã£o.', accent: '#fff', x: 96, y: 29, updated: 'agora' },
    { id: 'skill-tdd', title: 'TDD', tag: 'Engineering', excerpt: 'Desenvolvimento guiado por testes.', content: '# TDD\n\nFluxo red, green e refactor para mudanÃ§as seguras.', accent: '#fff', x: 96, y: 41, updated: 'agora' },
    { id: 'skill-design', title: 'Design & UI', tag: 'Skills', excerpt: 'Interfaces intencionais e testes visuais.', content: '# Design & UI\n\nDireÃ§Ã£o visual e validaÃ§Ã£o funcional da interface.', accent: '#fff', x: 84, y: 55, updated: 'agora' },
    { id: 'skill-frontend', title: 'Frontend design', tag: 'Design', excerpt: 'Identidade visual e composiÃ§Ã£o.', content: '# Frontend design\n\nCria interfaces distintas, deliberadas e coerentes com o produto.', accent: '#fff', x: 96, y: 52, updated: 'agora' },
    ...
    { id: 'skill-automation', title: 'Automation', tag: 'Skills', excerpt: 'Scraping, MCP e fluxos operacionais.', content: '# Automation\n\nFerramentas para integrar serviÃ§os e automatizar tarefas.', accent: '#fff', x: 68, y: 76, updated: 'agora' },
    { id: 'skill-scraper', title: 'Zenox scraper', tag: 'Automation', excerpt: 'ExtraÃ§Ã£o estruturada da web.', content: '# Zenox scraper\n\nFramework Playwright para coleta e estruturaÃ§Ã£o de dados web.', accent: '#fff', x: 77, y: 91, updated: 'agora' },
    { id: 'skill-mcp', title: 'MCP builder', tag: 'Automation', excerpt: 'IntegraÃ§Ãµes por ferramentas MCP.', content: '# MCP builder\n\nConstrÃ³i servidores MCP com interfaces de ferramentas bem definidas.', accent: '#fff', x: 63, y: 94, updated: 'agora' },
    { id: 'skill-knowledge', title: 'Knowledge work', tag: 'Skills', excerpt: 'Pesquisa, documentaÃ§Ã£o e escrita.', content: '# Knowledge work\n\nSkills para transformar fontes em conhecimento reutilizÃ¡vel.', accent: '#fff', x: 38, y: 78, updated: 'agora' },
    { id: 'skill-research', title: 'Research', tag: 'Knowledge', excerpt: 'Pesquisa em fontes primÃ¡rias.', content: '# Research\n\nInvestiga questÃµes e registra resultados verificÃ¡veis.', accent: '#fff', x: 27, y: 92, updated: 'agora' },
    { id: 'skill-docs', title: 'Doc coauthoring', tag: 'Knowledge', excerpt: 'CriaÃ§Ã£o colaborativa de documentos.', content: '# Doc coauthoring\n\nEstrutura documentaÃ§Ã£o, propostas e especificaÃ§Ãµes.', accent: '#fff', x: 42, y: 96, updated: 'agora' },
    { id: 'skill-security', title: 'Security', tag: 'Skills', excerpt: 'Auditoria e reconhecimento autorizado.', content: '# Security\n\nCapacidades de avaliaÃ§Ã£o de seguranÃ§a e pesquisa pÃºblica.', accent: '#fff', x: 17, y: 59, updated: 'agora' },
    { id: 'skill-pentest', title: 'Zenox pentest', tag: 'Security', excerpt: 'Testes autorizados de aplicaÃ§Ãµes web.', content: '# Zenox pentest\n\nFramework de avaliaÃ§Ã£o de seguranÃ§a para aplicaÃ§Ãµes autorizadas.', accent: '#fff', x: 5, y: 53, updated: 'agora' },
    { id: 'skill-dorks', title: 'Google dorks', tag: 'Security', excerpt: 'Pesquisa pÃºblica avanÃ§ada.', content: '# Google dorks\n\nOperadores avanÃ§ados para investigaÃ§Ã£o de informaÃ§Ãµes pÃºblicas.', accent: '#fff', x: 7, y: 68, updated: 'agora' },
  ];
  ...
  const createSession = (projectId = null) => {
    ...
    const session = {
      id: 'ses_' + uid(),
      title: project ? `New chat Â· ${project.name}` : `New chat ${state.sessions.length + 1}`,
      messages: [],
  ...
  const tplBrowserPanel = () => {
    if (!window.ZenoNativeBrowser?.available()) return `<div class="native-browser-required"><div>${icon('oc-global', 'remixicon h-6 w-6')}</div><h3>Runtime nativo necessÃ¡rio</h3><p>HTML e iframe nÃ£o sÃ£o navegador. Execute <code>ZenoBrowser.exe</code> para usar WebCore real.</p></div>`;
  ...
  const tplProjectSidebarRow = (project) => {
    ...
    return `<div class="zeno-project-group ${active ? 'is-active' : ''}">
      ...
      <div class="zeno-project-folders" title="${esc(project.folders.join(' Â· '))}">${project.folders.map(esc).join(' Â· ')}</div>
          ...
          <div class="overflow-hidden">
            ...
            <div class="relative overflow-hidden">
              <div data-testid="chat-input" data-chat-input="true" class="composer-editor w-full [&_.cm-editor]:h-full min-h-[52px] px-3 relative z-10 pt-4 pb-2 typography-markdown md:typography-ui-label">
                <div class="cm-editor Í¼1 Í¼2 Í¼4 Í¼p Í¼o">
                  <div class="cm-scroller" style="max-height: 180px;">
                    <div spellcheck="false" autocorrect="off" autocapitalize="none" writingsuggestions="false" translate="no" contenteditable="true" style="tab-size: 4;" class="cm-content cm-lineWrapping" role="textbox" aria-multiline="true" aria-placeholder="Digite uma instruÃ§Ã£o para o Zeno Agent" data-composer-input><div class="cm-line"><img class="cm-widgetBuffer" aria-hidden="true"><span class="cm-placeholder" data-animated-placeholder aria-hidden="true" contenteditable="false" style="pointer-events: none;"></span><br></div></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-input-column relative overflow-visible">
            <div class="contents">${chatInput()}
              <div class="flex flex-wrap items-center justify-center gap-1.5 chat-input-column mt-6" data-quick-actions-list>
                ...
                <div class="group/chip relative" draggable="true" data-quick-action data-quick-index="${index}" title="Arraste para mover Â· botÃ£o direito para editar">
        ...
        <div class="relative">
          <div class="relative w-full group/message" style="contain: layout; transform: translateZ(0px);">
            <div class="flex items-center gap-2 py-1.5">
              ...
              <span class="text-sm text-muted-foreground/70 italic">thinkingâ€¦</span>
            </div>
          </div>
        </div>
      </div>
  ...
  const tplMemoryNoteModal = () => {
    ...
    const previewing = editing && state.memoryPreview;
      ...
      <article role="dialog" aria-modal="true" aria-label="${esc(note.title)}" class="memory-note-dialog oc-dialog">
        <header class="memory-note-header">
          ...
          <div class="memory-note-actions">
            ${editing ? `<button type="button" data-action="toggle-memory-preview" class="memory-editor-preview">${previewing ? 'Edit' : 'Preview'}</button><button type="button" data-action="save-memory-note" class="memory-editor-save">Save</button><button type="button" data-action="discard-memory-note" class="memory-editor-discard">Discard</button>` : `<button type="button" data-action="edit-memory-note" class="memory-icon-button" title="Edit note" aria-label="Edit note">${icon('oc-edit', 'remixicon h-4 w-4')}</button>`}
        ...
        <div class="memory-note-scroll">
          <div class="memory-note-content">${editing ? (previewing ? `<div class="memory-editor-preview-content">${renderMarkdown(state.memoryEditor.content)}</div>` : `<textarea data-memory-content class="memory-editor-content" aria-label="Note content">${esc(state.memoryEditor.content)}</textarea>`) : renderMarkdown(note.content)}</div>
        </div>
      </article>
    </div>`;
  };
  ...
  const tplMemoryWorkspace = () => {
    ...
    return `<div class="memory-view" data-memory-view>
      ...
      <div class="memory-map-viewport" data-memory-viewport>
        <svg class="memory-map-canvas" data-memory-canvas viewBox="0 0 1600 900" aria-label="Memory knowledge graph" shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
          <g data-memory-world>
            <g data-memory-edges>${edges}</g>
            <g data-memory-nodes>${notes.map(tplMemoryNode).join('')}</g>
          </g>
        </svg>
        <div class="memory-map-help">Drag to move Â· Scroll to zoom Â· Double-click to open Â· Right-drag to connect</div>
      </div>
      ${tplMemoryNoteModal()}
    </div>`;
  };
  ...
  const tplProjectsWorkspace = () => `
    <div class="workspace-view projects-view">
      <header class="workspace-view-header">
        <div><div class="workspace-eyebrow">Workspace / Projects</div><h1>Projects</h1><p>Junte pastas e chats em um contexto que continua de sessÃ£o para sessÃ£o.</p></div>
  ...
  const tplMarketplaceWorkspace = () => `
    <div class="workspace-view marketplace-view">
      ...
      <div class="marketplace-card-grid"><div class="marketplace-card"><span class="marketplace-card-icon">${icon('oc-ai-generate-2', 'remixicon h-5 w-5')}</span><div><strong>Skills</strong><p>Fluxos prontos para tarefas especÃ­ficas, preparados para entrar no seu workspace.</p></div><span class="marketplace-card-badge">Soon</span></div><div class="marketplace-card"><span class="marketplace-card-icon">${icon('oc-puzzle-2', 'remixicon h-5 w-5')}</span><div><strong>Plugins</strong><p>Conecte ferramentas externas e amplie o que o Zeno consegue fazer.</p></div><span class="marketplace-card-badge">Soon</span></div></div>
    </div>`;

  const tplSquadWorkspace = () => `
    <div class="workspace-view squad-view">
      <header class="workspace-view-header"><div><div class="workspace-eyebrow">Zeno / Squad</div><h1>Squad</h1><p>Monte uma equipe de agentes com papÃ©is diferentes para pensar, construir e revisar.</p></div><span class="workspace-status-pill">Coming soon</span></header>
      <div class="workspace-empty-state squad-empty-state"><div class="workspace-empty-icon squad-empty-icon">${icon('oc-ai-agent', 'remixicon h-7 w-7')}</div><h2>Agent squads are next</h2><p>Esta superfÃ­cie jÃ¡ estÃ¡ no workspace. A criaÃ§Ã£o e coordenaÃ§Ã£o de squads chega na prÃ³xima etapa.</p></div>
    </div>`;
    ...
    if (state.modal === 'project') {
      return `<div class="fixed inset-0 z-[80] flex items-center justify-center bg-black/60 p-3 backdrop-blur-[3px] oc-backdrop" data-action-modal>
        <div role="dialog" aria-modal="true" aria-label="Create project" class="oc-dialog project-dialog">
          <header class="project-dialog-header"><div><div class="workspace-eyebrow">Workspace / Projects</div><h2>Create a project</h2><p>Defina um contexto durÃ¡vel para seus chats e pastas.</p></div><button type="button" data-action="close-modal" aria-label="Close dialog" class="memory-icon-button">${icon('oc-close', 'remixicon h-4 w-4')}</button></header>
          <form data-project-form class="project-dialog-form">
            ...
            <aside class="project-dialog-aside"><div class="project-aside-icon">${icon('oc-folder-add', 'remixicon h-6 w-6')}</div><strong>One context, many chats</strong><p>Os chats criados dentro deste projeto vÃ£o compartilhar as pastas selecionadas sem misturar o restante do seu workspace.</p><div class="project-aside-rule"></div><span>${icon('oc-information', 'remixicon h-3.5 w-3.5')} Stored locally in this browser</span></aside>
  ...
  const tplPanelBody = (label) => {
    switch (label) {
      ...
      case 'Stack':
        return `<div class="flex h-full flex-col p-3"><div class="rounded-lg border border-border/70 bg-[var(--surface-elevated)] p-3"><div class="flex items-center gap-2 text-sm font-medium text-foreground">${icon('oc-stack', 'remixicon h-4 w-4 text-muted-foreground')}Stack</div><p class="mt-2 text-xs leading-relaxed text-muted-foreground">Camada de contexto da sessÃ£o: mensagens, ferramentas e artefatos usados nesta conversa.</p></div><div class="mt-3 space-y-1.5 text-xs text-muted-foreground"><div class="rounded-md border border-border/60 px-2.5 py-2">Contexto ativo</div><div class="rounded-md border border-border/60 px-2.5 py-2">Ferramentas disponÃ­veis</div><div class="rounded-md border border-border/60 px-2.5 py-2">Notas do projeto</div></div></div>`;
      case 'Terminal':
        return `
  ...
  const captureMemoryNote = () => {
    ...
    const source = message?.text || (message?.code?.lines || []).map(([line]) => line).join('') || 'Ainda nÃ£o hÃ¡ uma resposta nesta sessÃ£o. Esta nota pode receber contexto novo conforme o trabalho avanÃ§a.';
    const title = message ? `Session note Â· ${session.title}` : 'New captured note';
    const note = {
      id: 'memory_' + uid(),
      title,
      tag: 'Captured note',
      excerpt: source.replace(/[`*_#\n]/g, ' ').trim().slice(0, 116) + (source.length > 116 ? 'â€¦' : ''),
  ...
  const bindMemory = (rootEl) => {
    // A right-drag is reserved for creating an edge, never for opening a note.
    let suppressNoteOpenUntil = 0;
    const noteOpeningSuppressed = () => Date.now() < suppressNoteOpenUntil;
    ...
    $$('[data-memory-note]', rootEl).forEach((node) => node.addEventListener('dblclick', (event) => {
      ...
      if (event.button !== 0 || event.defaultPrevented || noteOpeningSuppressed()) return;
    ...
    if (viewport && canvas) {
      ...
      let connectingFrom = null, connectionLine = null;
       const world = $('[data-memory-world]', canvas);
       const transform = () => { world?.setAttribute('transform', `translate(${x} ${y}) scale(${scale})`); };
      ...
      viewport.addEventListener('click', (event) => {
        if (event.button !== 0 || event.defaultPrevented || noteOpeningSuppressed()) {
          if (noteOpeningSuppressed()) event.preventDefault();
          return;
        }
      ...
      viewport.addEventListener('pointercancel', cancelConnection);
    ...
    $$('[data-memory-action]', rootEl).forEach((action) => action.addEventListener('click', (event) => {
      ...
      if (type === 'view') { state.noteId = note.id; state.memoryEditor = null; state.memoryPreview = false; render(); }
      if (type === 'edit') openMemoryEditor(note);
      if (type === 'delete') {
        const label = action.querySelector('text');
        if (action.dataset.confirming) {
          ...
          action.dataset.confirming = '1';
          if (label) label.textContent = 'Confirmar?';
          setTimeout(() => { delete action.dataset.confirming; if (label && label.isConnected) label.textContent = 'Delete'; }, 2200);
        }
      }
    }));
    $('[data-action="edit-memory-note"]', rootEl)?.addEventListener('click', () => openMemoryEditor(memoryNoteById(state.noteId)));
    const syncMemoryEditor = () => {
      if (!state.memoryEditor) return;
      const title = $('[data-memory-title]', rootEl);
      const content = $('[data-memory-content]', rootEl);
      if (title) state.memoryEditor.title = title.value;
      if (content) state.memoryEditor.content = content.value;
    };
    $('[data-action="toggle-memory-preview"]', rootEl)?.addEventListener('click', () => {
      syncMemoryEditor();
      state.memoryPreview = !state.memoryPreview;
      render();
    });
    $('[data-action="save-memory-note"]', rootEl)?.addEventListener('click', () => {
      ...
      if (!note) return;
      syncMemoryEditor();
      note.title = state.memoryEditor?.title.trim() || 'Untitled note';
      note.content = state.memoryEditor?.content || '';
      note.excerpt = note.content.replace(/[`*_#\n]/g, ' ').trim().slice(0, 116);
      state.memoryEditor = null; state.memoryPreview = false; LS.set('oc-clone-memory-notes', state.memoryNotes); render();
    });
    $('[data-action="discard-memory-note"]', rootEl)?.addEventListener('click', () => {
      if (state.memoryEditor?.isNew) state.memoryNotes = state.memoryNotes.filter((note) => note.id !== state.noteId);
       state.memoryEditor = null; state.memoryPreview = false; state.noteId = null; render();
    });
    $$('[data-action="capture-memory"]', rootEl).forEach((button) => button.addEventListener('click', captureMemoryNote));
    $('[data-action="close-note"]', rootEl)?.addEventListener('click', () => { state.noteId = null; state.memoryEditor = null; state.memoryPreview = false; render(); });
    $('[data-note-backdrop]', rootEl)?.addEventListener('click', () => { state.noteId = null; state.memoryEditor = null; state.memoryPreview = false; render(); });
  };
  ...
  const requestMicrophone = async () => {
    ...
    if (permission === 'denied') throw new Error('PermissÃ£o do microfone bloqueada nas configuraÃ§Ãµes do navegador.');
  ...
  const transcribeAudio = async (blob) => {
    ...
    if (typeof transcribe !== 'function') throw new Error('TranscriÃ§Ã£o disponÃ­vel somente no aplicativo Zeno Agent.exe.');
  ...
  const finishDictation = async (runtime) => {
    ...
    try {
      if (!blob.size) throw new Error('Nenhum Ã¡udio foi capturado.');
      ...
      setDictationUi(runtime.rootEl, 'error', error.message || 'Falha na transcriÃ§Ã£o.');
  ...
  const bindDictation = (rootEl) => {
    ...
    button.addEventListener('click', async () => {
      ...
      if (!navigator.mediaDevices?.getUserMedia || !window.MediaRecorder) {
        setDictationUi(rootEl, 'error', 'Microfone indisponÃ­vel neste navegador.');
      ...
      try {
        ...
        recorder.addEventListener('error', () => { stream.getTracks().forEach((track) => track.stop()); activeDictation = null; setDictationUi(rootEl, 'error', 'Falha ao capturar o Ã¡udio.'); setTimeout(() => setDictationUi(rootEl, 'idle'), 3200); });
        recorder.start();
        setDictationUi(rootEl, 'recording', 'Gravando...');
      } catch (error) {
        setDictationUi(rootEl, 'error', error.message || 'PermissÃ£o do microfone negada.');
        setTimeout(() => setDictationUi(rootEl, 'idle'), 3200);
      }
    });
  };
  ...
  const bindComposer = (rootEl) => {
    ...
    $$('[data-quick-action]', rootEl).forEach((item) => {
      ...
      item.addEventListener('contextmenu', (event) => {
        ...
        const next = window.prompt('Editar mensagem rÃ¡pida', current?.[1] || '');
  ...
  const mockReply = (text) => {
    ...
    if (t.includes('array') || t.includes('foreach') || t.includes('map')) {
      return { ...base, thinking: 'The user wants to iterate over an array. A classic for loop with an index is the most direct answer â€” access each element by position from 0 to length-1.', text: 'Percorrer um array com `for` acessa cada elemento pelo Ã­ndice, do primeiro ao Ãºltimo.', code: { lang: 'js', lines: [['const', 'keyword'], [' ', null], ['nums', 'variable'], [' =', 'operator'], [' [1', 'number'], [',', 'operator'], [' 2', 'number'], [',', 'operator'], [' 3', 'number'], ['];', 'operator'], ['\n', null], ['for', 'keyword'], [' (', null], ['let', 'keyword'], [' ', null], ['i', 'variable'], [' =', 'operator'], [' 0', 'number'], [';', 'operator'], [' ', null], ['i', 'variable'], [' <', 'operator'], [' ', null], ['nums', 'variable'], ['.length', 'operator'], [';', 'operator'], [' ', null], ['i', 'variable'], ['++', 'operator'], [')', 'operator'], [' ', null], ['console.log', 'function'], ['(', null], ['nums', 'variable'], ['[', 'operator'], ['i', 'variable'], [']', 'operator'], [')', 'operator'], [';', 'operator']] }, recap: `Percorrer arrays com \`for\` clÃ¡ssico usa o Ã­ndice \`i\` de 0 atÃ© \`array.length - 1\`, acessando \`array[i]\` a cada iteraÃ§Ã£o.`, suggestion: 'E como fazer o mesmo com `forEach` ou `map`?' };
    }
    if (t.includes('arquivo') || t.includes('file') || t.includes('list') || t.includes('bash') || t.includes('tool')) {
      return { ...base, thinking: 'The user asks to list files. I should use the shell tool to run a directory listing and report the output back.', tools: [{ title: 'Shell Command', cmd: 'Get-ChildItem -Path "C:\\Users\\GM METELURGICA"', duration: '5.6s', output: DIR_OUTPUT }], text: 'Aqui estÃ¡ a listagem do diretÃ³rio atual usando **Shell Command**:\n\nO diretÃ³rio contÃ©m pastas de configuraÃ§Ã£o e projetos, incluindo `Pictures`, `AppData`, `Downloads` e `.ollama`.', recap: 'Listagem do diretÃ³rio via shell: contÃ©m .agents, .aws, .bun, .buzz, Pictures, AppData, Downloads e mais.', suggestion: 'Liste tambÃ©m os arquivos do projeto GUI Zeno.' };
    }
    if (t.includes('funÃ§Ã£o') || t.includes('function') || t.includes('python')) {
      return { ...base, thinking: 'They want a function example. A named function with parameters and a return statement is the clearest illustration in JavaScript.', text: 'Uma **funÃ§Ã£o** em JavaScript Ã© um bloco reutilizÃ¡vel de cÃ³digo que recebe entradas (parÃ¢metros) e pode devolver um resultado com `return`.', code: { lang: 'js', lines: [['function', 'keyword'], [' ', null], ['soma', 'variable'], ['(', null], ['a', 'variable'], [',', 'operator'], [' ', null], ['b', 'variable'], [')', 'operator'], [' ', null], ['{', 'operator'], ['\n', null], ['  ', null], ['return', 'keyword'], [' ', null], ['a', 'variable'], [' +', 'operator'], [' ', null], ['b', 'variable'], [';', 'operator'], ['\n', null], ['}', 'operator']] }, recap: 'FunÃ§Ãµes encapsulam lÃ³gica reutilizÃ¡vel com parÃ¢metros e retorno via `return`.', suggestion: 'Explique arrow functions e quando usÃ¡-las.' };
    }
    return { ...base, thinking: 'The request is open-ended. I will acknowledge it, restate the core ask briefly, and offer to go deeper with concrete examples.', text: 'Entendi seu pedido: **"' + text.slice(0, 60) + (text.length > 60 ? 'â€¦' : '') + '"**. Em resumo, Ã© possÃ­vel fazer isso de forma direta e eficiente, separando o problema em etapas pequenas e verificando cada resultado parcial antes de avanÃ§ar. Se quiser, posso detalhar com exemplos de cÃ³digo.', recap: 'Resposta gerada para: "' + text.slice(0, 48) + '". Foco em soluÃ§Ã£o direta com verificaÃ§Ã£o por etapas.', suggestion: 'Pode dar um exemplo prÃ¡tico disso?' };
  };
    ...
    pal.innerHTML = `
      <div class="oc-dialog w-full max-w-xl overflow-hidden rounded-xl border border-border/80 bg-popover text-popover-foreground shadow-2xl">
        <div class="flex items-center gap-2 border-b border-border/70 px-3">
          ...
          <input id="oc-clone-palette-input" class="h-11 w-full bg-transparent text-sm outline-none placeholder:text-muted-foreground" placeholder="Type a command or search sessionsâ€¦" autocomplete="off">
